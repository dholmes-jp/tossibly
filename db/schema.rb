...
ActiveRecord::Schema[8.1].define(version: 2026_09_02_011223) do
  ...
  create_table "items", force: :cascade do |t|
    ...
    t.string "brand"
    t.string "category"
    t.integer "confirmed_price", default: 0
    t.datetime "created_at", null: false
    t.text "description"
    ...
    t.string "jimoty_search_keyword"
    t.boolean "listable", default: true, null: false
    t.string "model_number"
    t.jsonb "nearby_listings", default: {}, null: false
    t.string "platform", default: "other"
